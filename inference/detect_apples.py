...
def detect_apples(model, image_tensor, threshold=0.5, device="cpu"):
    """
    Обнаруживает яблоки на изображении.
...
def main():
    ...
    results = detect_apples(model, image_tensor, threshold=args.threshold, device=device)
